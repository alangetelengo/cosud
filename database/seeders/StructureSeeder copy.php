...
class StructureSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $structures = [
            ...
            // 4 services DDSAIT (selon l’organigramme / métiers)
            ['SVC-DDI-DEVINT', 'Service du développement et de l’intégration des applications', 'service', 'DDSAIT'],
            ['SVC-DDI-BDD', 'Service de la conception et de l’administration des bases de données', 'service', 'DDSAIT'],
            ['SVC-DDI-MAINT', 'Service de la maintenance des systèmes applicatifs', 'service', 'DDSAIT'],
            ['SVC-DDI-VEILLE', 'Service de la veille et de l’innovation technologique', 'service', 'DDSAIT'],
