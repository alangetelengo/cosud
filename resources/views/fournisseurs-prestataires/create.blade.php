...
@section('page-title', 'Nouvelle fiche fournisseur / prestataire')
@section('page-title-info', 'Référentiel COSUD')

@section('content')
@include('partials.flash-session', ['class' => 'mb-4'])

<div class="max-w-2xl">
    <form method="post" action="{{ route('fournisseurs-prestataires.store') }}"
        ...
        @csrf
        @include('fournisseurs-prestataires.partials.form')
