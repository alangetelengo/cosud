...
<div class="space-y-8">
    ...
    <div class="relative overflow-hidden rounded-2xl bg-slate-800 bg-gradient-to-br from-emerald-600 via-teal-700 to-cyan-800 p-6 sm:p-8 shadow-xl">
        ...
        <div class="relative flex flex-col sm:flex-row sm:items-center sm:justify-between gap-6">
            <div>
                <p class="text-white text-sm font-bold uppercase tracking-wider drop-shadow-sm">Bienvenue</p>
                <h2 class="text-xl sm:text-2xl font-bold text-white mt-1 drop-shadow-sm">Mon espace documentaire</h2>
                <p class="text-white font-bold mt-2 drop-shadow-sm">{{ $nbMesDocuments }} document(s) · {{ $nbDossiersFavoris }} dossier(s) favori(s)</p>
            </div>
