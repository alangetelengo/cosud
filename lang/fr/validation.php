...
return [
    ...
    /*
    |--------------------------------------------------------------------------
    | Validation Language Lines (French - GED)
    |--------------------------------------------------------------------------
    |
    | Messages d'erreur de validation explicites pour l'utilisateur.
    |
    */
    ...
    */
    ...
    'custom' => [
        'email' => [
            'unique' => 'Cette adresse e-mail est déjà utilisée par un autre compte. Veuillez en choisir une autre.',
        ],
        'name' => [
    ...
    */
    ...
    'attributes' => [
        ...
        'type_dossier_id' => 'type de dossier',
        'type_metadonnee_id' => 'type de métadonnée',
        'extension_defaut' => 'extension par défaut',
        'taille_max_ko' => 'taille maximale (Ko)',
        'duree_conservation_annees' => 'durée de conservation (années)',
