...
class FournisseurPrestataireService
{
     ...
     *     telephone?: ?string,
     *     telephone_2?: ?string,
     *     notifier_telephone?: bool,
     *     notifier_telephone_2?: bool,
     *     type_contrat?: ?string,
     *     a_contrat?: bool,
    ...
    public function creer(User $acteur, array $donnees): FournisseurPrestataire
    {
        ...
        $fiche = FournisseurPrestataire::query()->create([
            ...
            'notifier_telephone' => (bool) ($donnees['notifier_telephone'] ?? true),
            'notifier_telephone_2' => (bool) ($donnees['notifier_telephone_2'] ?? true),
