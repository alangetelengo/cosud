...
class UpdateFactureRegularisationRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        ...
        $aDejaDesScans = $courrier instanceof Courrier && $courrier->documents()->exists();
        ...
        return [
            ...
            'fichiers' => [$aDejaDesScans ? 'nullable' : 'required', 'array', 'max:20'],
    ...
    public function messages(): array
    {
        return [
            ...
            'fournisseur_prestataire_id.required' => 'Sélectionnez un fournisseur / prestataire du référentiel, ou saisissez un nouveau nom.',
