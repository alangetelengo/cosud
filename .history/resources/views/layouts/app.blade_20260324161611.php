    ...
    <body class="font-sans antialiased min-h-screen bg-gray-100 dark:bg-slate-900">
            ...
            @elseif(View::hasSection('page-title'))
                <header class="bg-white dark:bg-slate-800 shadow">
                    <div class="@yield('content-container-class', 'max-w-7xl mx-auto px-4 sm:px-6 lg:px-8') py-6 flex flex-wrap items-center justify-between gap-4">
                        <div>
                            <h1 class="text-2xl font-bold text-slate-800 dark:text-slate-100">@yield('page-title')</h1>
                            @hasSection('page-title-info')<p class="text-sm text-slate-500 dark:text-slate-400 mt-1">@yield('page-title-info')</p>@endif
                        </div>
                        @yield('btn-create')
                    </div>
                </header>
        ...
        <div id="flashAlertModal" style="
            ...
            <div style="
                ...
                <p id="flashAlertMessage" style="color:#64748b; font-size:0.95rem; line-height:1.5; margin-bottom:1.75rem;"></p>
        ...
        (function () {
            ...
            window.flashAlert = function (message, formOrCb, options) {
                options = options || {};
                document.getElementById('flashAlertMessage').textContent = message;
                document.getElementById('flashAlertTitle').textContent   = options.title || 'Confirmation';
            ...
            window.flashAlertCancel = function () {
                ...
                _form = null; _cb = null; _inputOpt = null;
            };
            function doConfirm() {
